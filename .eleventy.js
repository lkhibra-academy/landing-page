...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addShortcode("image", async function (src, alt, formats, widths, sizes, attributes = {}) {
  ...
  eleventyConfig.addPassthroughCopy({
    public: "./",
    "node_modules/cleave.js/dist/addons/cleave-phone.ma.js": "./js/cleave-phone.ma.js"
  });
  eleventyConfig.on("afterBuild", () => {
    return esbuild.build({
      entryPoints: ["./plugins/app.ts", "./plugins/cta.ts", "./plugins/swiper.ts", "./plugins/mask.js"],
      bundle: true,
