          ...
          <div className=" flex flex-col items-center max-w-6xl mx-auto px-5 sm:px-6 py-8 ">
              <div className="flex flex-col w-full prose text-left max-w-max lg:max-w-2xl ">
                  <div dir='rtl' className="w-full mx-auto text-center">
                      <h1 className='h2 mb-4'>إنضم إلى أكثر من 80 طالب </h1>
              ...
              <div className="flex flex-wrap justify-center mt-8 gap-4">
                    <Link to='/Frontend' className="block w-full px-12 py-3 text-base font-medium text-white bg-red-primary rounded shadow sm:w-auto " href="/get-started">
                    ابدأ الآن
                    </Link>  
                </div>
          </div>
