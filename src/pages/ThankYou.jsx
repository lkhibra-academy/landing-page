    ...
    return (
        ...
        <section className='flex flex-col min-h-screen overflow-hidden mb-10'>
            <div className="relative mx-auto max-w-screen-2xl">
                ...
                <div className="md:mx-auto p-2 md:p-4 rounded-lg border border-gray-200 shadow-md
                flex justify-center items-center flex-col max-w-lg ">
                    {/* Head */}
...
وسوف نتصل بك في أقرب وقت من أجل التأكيد </p>
                    {/* <a href="https://www.instagram.com/lkhibra.ma/"
                            className="btn text-white bg-red-primary
                            hover:text-red-primary hover:outline hover:outline-1 hover:outline-red-primary hover:bg-white 
                             mb-4 w-auto sm:mb-0"
                    >
                            بغيت نتعلم
                    </a> */}
        ...
        {/*  Site footer */}
        <Footer />
        <a href="https://www.instagram.com/_u/lkhibra.ma" 
        className="whatsapp-button z-50 sm:hidden" 
            target="_blank" style={{
                position: 'fixed',
                right: '10px',
                bottom: '20px'
